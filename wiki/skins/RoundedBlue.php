...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="<?php $this->text('lang') ?>" lang="<?php $this->text('lang') ?>" dir="<?php $this->text('dir') ?>">
	<head>
		...
		<!--<script type="text/javascript" src="http://en.wikipedia.org/w/index.php?title=User:Cacycle/wikEd.js&action=raw&ctype=text/javascript"></script>-->
...
<?php if($this->data['body_onload'    ]) { ?>onload="<?php     $this->text('body_onload')     ?>"<?php } ?>
 class="<?php $this->text('nsclass') ?> <?php $this->text('dir') ?>">
	<div id="globalWrapper">
		<div id="masthead">
			<h1><a href="<?php echo htmlspecialchars($this->data['nav_urls']['mainpage']['href'])?>" style="text-transform: none;">Wiki</a></h1> 
			<h2><?php /*$this->html('subtitle')*/ ?>Wiki for oppl&aelig;ring og rutiner p&aring; Vitenfabrikken</h2>
		</div>
