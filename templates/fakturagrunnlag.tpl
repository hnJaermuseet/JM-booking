...
{if $resourcenum|strlen > 0}<b>Ressursnummer:</b> {$resourcenum}<br>{/if}
<br>

{if $invoice_comment|strlen > 0}
<b>Kommentar:</b><br />
{$invoice_comment}<br /><br />
{/if}
{if $invoice_internal_comment|strlen > 0}
<b>Intern kommentar:</b><br />
{$invoice_internal_comment}<br /><br />
{/if}
<br>
