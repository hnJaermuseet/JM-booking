...
<tr>
	<td align="right">{iconHTML ico='house'} <b>Bygg:</b> </td>
	<td>{$area}</td>
</tr>
...
<tr class="hiddenprint">
	...
	<td><a href="infoskjerm.php?area={$area_id}&amp;date={$time_start|date_format:"%d.%m.%Y"}"{if $infoscreen_txt == ""} style="color: gray;"{/if}>Forhåndsvis kvelden for det nåværende bygget *</td>
</tr>
<tr class="hiddenprint">
