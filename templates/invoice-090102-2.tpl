...
<body>
<div style="position: relative; float: right; right:10px; top:30px; font-size: xx-large;" align="right"><b>{$invoice_heading}</b></div>
<div style="position: relative; float: right; right:10px; top:70px;" align="right">
...
<div style="font-size: xx-small; position: relative; float: left; top:55px;"><b>Adresse:</b> Postboks 250, 4367 NÆRBØ<br><b>Org.nr.:</b> NO 971 098 767 MVA<br><b>Banknr:</b> 123</div>
<div style="font-size: xx-small; position: relative; float: left; top:55px; left:250px;"><b>Telefon: </b> (+47) 51 79 94 20<br><b>Telefaks: </b> (+47) 51 79 94 21<br><b>Nettside: </b> http://www.jaermuseet.no/</div>
<br>
<br>
<br>
<br>
