...
_b.AutoSuggest=function(b,c, idfield, idfield2) {
	...
	_b.AutoSuggest.prototype.onKeyUp=function(a)
	{
		...
		_b.AutoSuggest.prototype.getSuggestions=function(a)
		{
			...
			if(this.nInpC>b&&l&&l<this.oP.maxentries&&this.oP.cache)
			{
				...
				var d=this;var e=this.sInp;clearTimeout(this.ajID);
		...
		_b.AutoSuggest.prototype.setSuggestions=function(a,b){
			...
			if(this.oP.json){
				...
				for(var i=0;i<c.results.length;i++){
					this.aSug.push({'id':c.results[i].id,'value':replace_nor_char(c.results[i].value),'info':c.results[i].info})
				}
			}else{
				var d=a.responseXML;
				...
				for(var i=0;i<e.length;i++){
					if(e[i].hasChildNodes())
						this.aSug.push({'id':e[i].getAttribute('id'),'value':replace_nor_char(e[i].childNodes[0].nodeValue),'info':e[i].getAttribute('info')})
				}
			}
		...
		_b.AutoSuggest.prototype.setHighlight=function(n)
		{
			...
			if(!a)return false;if(this.iHigh>0)this.clearHighlight();this.iHigh=Number(n);
		...
		_b.AutoSuggest.prototype.clearHighlight=function() {
			var a=_b.DOM.gE("as_ul");
			if(!a)return false;
			if(this.iHigh>0){a.childNodes[this.iHigh-1].className="";this.iHigh=0}
		};
		_b.AutoSuggest.prototype.setHighlightedValue=function() {
			if(this.iHigh) {
				//this.sInp=this.fld.value=replace_nor_char(this.aSug[this.iHigh-1].value);
				this.sInp=this.fld.value=this.aSug[this.iHigh-1].value;
				this.idf.value=this.aSug[this.iHigh-1].id;
				if(this.idfield2 != '')
					this.idf2.value=this.aSug[this.iHigh-1].id;
				this.fld.focus();
				...
				selectCustomer(this.aSug[this.iHigh-1].id);
			}
		};
		...
		if(typeof(_b.Fader)=="undefined")_b.Fader={};_b.Fader=function(a,b,c,d,e){if(!a)return 0;this.e=a;this.from=b;this.to=c;this.cb=e;this.nDur=d;this.nInt=50;this.nTime=0;var p=this;this.nID=setInterval(function(){p._fade()},this.nInt)};_b.Fader.prototype._fade=function(){this.nTime+=this.nInt;var a=Math.round(this._tween(this.nTime,this.from,this.to,this.nDur)*100);
		var b=a/100;
		if(this.e.filters){try{this.e.filters.item("DXImageTransform.Microsoft.Alpha").opacity=a}catch(e){this.e.style.filter='progid:DXImageTransform.Microsoft.Alpha(opacity='+a+')'}}else{this.e.style.opacity=b}if(this.nTime==this.nDur){clearInterval(this.nID);if(this.cb!=undefined)this.cb()}};_b.Fader.prototype._tween=function(t,b,c,d){return b+((c-b)*(t/d))};