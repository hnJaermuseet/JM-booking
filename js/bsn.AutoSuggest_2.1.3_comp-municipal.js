...
_b.AutoSuggest=function(b,c) {
	...
	_b.AutoSuggest.prototype.getSuggestions=function(a){
		...
		if(this.nInpC>b&&l&&l<this.oP.maxentries&&this.oP.cache){var c=[];
		for(var i=0;i<l;i++){if(this.aSug[i].value.substr(0,a.length).toLowerCase()==a.toLowerCase())c.push(this.aSug[i])}this.aSug=c;
		...
		_b.AutoSuggest.prototype.changeHighlight=function(a) {
			...
			_b.AutoSuggest.prototype.setHighlight=function(n){var a=_b.DOM.gE("as_ul");
			...
			_b.AutoSuggest.prototype.setHighlightedValue=function() {
				if(this.iHigh) {
					...
					choose_municipal(this.aSug[this.iHigh-1].id, replace_nor_char(this.aSug[this.iHigh-1].value));
